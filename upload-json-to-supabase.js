...
// List of all JSON files to download
const files = [
  ...
  'Delhi-Police-Constable-Previous-Paper-Held-On_-01-Dec-2020-Shift-3.json',
  'Delhi-Police-Constable-Previous-Paper-Held-On_-01-Dec-2020-Shift-3-Hindi.json',
  'Delhi-Police-Constable-Previous-Paper-Held-On_-03-Dec-2020-Shift-3-English.json',
  'Delhi-Police-Constable-Previous-Paper-Held-On_-03-Dec-2020-Shift-3-Hindi.json',
  'Delhi-Police-Constable-Previous-Paper-Held-On_-09-Dec-2020-Shift-3-English.json',
  'Delhi-Police-Constable-Previous-Paper-Held-On_-09-Dec-2020-Shift-3-Hindi.json',
  'Delhi-Police-Constable-Previous-Paper-Held-On_-10-Dec-2020-Shift-2-English.json',
  'Delhi-Police-Constable-Previous-Paper-Held-On_-10-Dec-2020-Shift-2-Hindi.json',
  'Delhi-Police-Constable-Previous-Paper-Held-on_-27-Nov-2020-Shift-3.json',
  'Delhi-Police-Constable-Previous-Paper-Held-on_-27-Nov-2020-Shift-3-Hindi.json',
...
function uploadToSupabase(examData) {
  return new Promise((resolve, reject) => {
    ...
    const url = new URL(`${SUPABASE_URL}/rest/v1/exam_archive`);
...
function parseExamName(filename) {
  ...
  // Determine state
  let state = 'National';
  if (name.toLowerCase().includes('tnpsc') || name.toLowerCase().includes('tamil')) {
    state = 'Tamil Nadu';
  }
...
function transformData(rawData, filename) {
  ...
  // Transform from archive_data to questions
...
async function processAllFiles() {
  ...
  for (const file of files) {
    try {
      ...
      await uploadToSupabase(examData);
      successCount++;
